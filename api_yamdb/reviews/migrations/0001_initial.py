# Generated by Django 3.2 on 2023-02-07 14:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Недопустимые символы", regex="^[\\w.@+-]"
                            )
                        ],
                ...
                (
                    "confirmation_code",
                    models.CharField(
                        default=uuid.uuid4, editable=False, max_length=150
                    ),
                ),
                (
                    "groups",
            ...
            fields=[
                ...
                (
                    ...
                    models.SlugField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Недопустимые символы", regex="^[-a-zA-Z0-9_]+$"
                            )
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "year",
                    models.IntegerField(validators=[reviews.validators.year_validator]),
                ),
                ...
                (
                    "genre",
                    models.ManyToManyField(
                        related_name="title", to="reviews.Genre", verbose_name="Жанр"
                    ),
                ),
            ],
        ),
